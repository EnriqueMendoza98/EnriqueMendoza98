...
public class MainActivity7 extends AppCompatActivity {
    ...
    public void Siguiente(View view) {
        /*Intent siguiente=new Intent(this, MainActivity8.class);
        startActivity(siguiente);*/
        final ProgressDialog progressDialog = new ProgressDialog(MainActivity7.this);
        ...
        if (codigo.getText().toString().equals("")) {
            Toast.makeText(MainActivity7.this, "Porfavor ingrese el codigo de categoria", Toast.LENGTH_LONG).show();
            seguir = 0;
        } else {
            seguir = 1;
        }
        if (categoria.getText().toString().equals("")) {
            Toast.makeText(MainActivity7.this, "Ingrese el nombre de categoria", Toast.LENGTH_LONG).show();
            seguir = 0;
        } else {
            seguir = 1;
        }
        if (estado.getText().toString().equals("")) {
            Toast.makeText(MainActivity7.this, "Ingrese el estado: 1-Activo 2-Inactivo", Toast.LENGTH_LONG).show();
            seguir = 0;
        } else {
            seguir = 1;
        }
                ...
                public void onResponse(String response) {
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            progressDialog.dismiss();
                            Toast.makeText(MainActivity7.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                        }
                    }
            ) {
                @Override
